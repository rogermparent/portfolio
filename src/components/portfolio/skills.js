    ...
    >
      ...
      <Skill heading="HTML5 and CSS3">
        <Paragraph>
          ...
          internet starts and ends with. I've experienced and learned from many
          website trends, and these days I like to focus on semantic HTML and
          efficient, backward-compatible CSS.
        </Paragraph>
      </Skill>
      ...
      <Skill heading="Gatsby.js">
        <Paragraph>
          ...
          increased in the two years I've been studying it- to the point where I
          even decided to make this portfolio with it! If you don't know about
          Gatsby, I invite you to{" "}
        ...
        <Paragraph>
          Working with Gatsby, I can create websites that pull content from any
          source, feature custom dynamic user interaction, and easily get
      ...
      <Skill heading="C-like Languages">
        <Paragraph>
          I've worked with and taken classes on Java, C, C++, C#, Ruby, Python,
          and a few others. While I could list each of these individually to pad
          out this skills section, it really comes down to me having a
      ...
      <Skill heading="Linux Administration">
        <Paragraph>
          ...
          Debian to Fedora and CentOS. I've used both SysVInit and SystemD
          environments, most desktop environments, and <i>tons</i> of the
          command line. Whether it be a webserver, database, or a humble kiosk,
          I can find my way around it if it runs Linux.
        </Paragraph>
        <Paragraph>
        ...
        <Paragraph>
          While I won't directly be using Linux in most development projects, It
          always helps to be familiar with the environment a project will be
          deployed on!
        </Paragraph>
      </Skill>
      ...
      <Skill heading="Communication">
        <Paragraph>
          It's no secret that "soft skills" are an important part of every job,
          including software development!
        </Paragraph>
        <Paragraph>
          While my previous jobs don't count much for my development skills, my
          time in retail let me develop the ability to profesionally communicate
          with both customers and team members alike! I can fit onto any team
          and get along with everybody.
        </Paragraph>
        <Paragraph>
          Not only can I get along with others, but I'm also good at breaking
          down technical concepts for laymen to understand. I do my best to keep
          jargon to a minimum and make sure everybody is up to speed!
        </Paragraph>
      </Skill>
    </Section>
  )
